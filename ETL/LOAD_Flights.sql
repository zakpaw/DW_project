...
SELECT COUNT(*) FROM DestinationTemp
...
AS SELECT 
	...
	V1.flight_duration,
	DB2.cost + V1.flight_cost AS 'cost',
	V1.airline_discount
...
(airline_ID, local_airport_ID, destination_airport_ID, flight_departure_start_ID, flight_departure_end_ID, flight_duration, cost, airline_discount)
